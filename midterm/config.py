...
class Crowd_human:
    ...
    image_folder = r'C:\Users\June hyoung Kwon\PROJECTS\KCC_2021\test\test_data\image'
    
    # train_source = os.path.join('/data/CrowdHuman/annotation_train.odgt')
    train_source = r'C:\Users\June hyoung Kwon\PROJECTS\KCC_2021\test\test_data\test_annotation.odgt'
    eval_source = r'C:\Users\June hyoung Kwon\PROJECTS\KCC_2021\test\test_data\test_annotation.odgt'
